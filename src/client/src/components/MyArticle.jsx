...
import { setArticleState, setComments } from '../reducers/articlesReducer';
            ...
            <div className={classes.articlePage}>
                <article className={classes.articleContainer}>
                    ...
                    <main>
                        <p>
                            Date of creation:{' '}
                            {formatDate(currentArticle?.date_of_creation)} /
                            created by{' '}
                            <span className={classes.greenSpan}>admin</span>
                        </p>
                        <div>
                            <div
                        ...
                        <div className={classes.commentArea}>
                            ...
                            <div className={commentItemStyles.CommentItem}>
                                <img
                                    ...
                                    src={userIsAdmin ? adminPic : userPic}
                                    width={80}
                                    height={80}
                                    alt=""
                                />
                                <div className={commentItemStyles.content}>
                                    <div className={commentItemStyles.names}>
                                        <h2>
                                            {userid !== -1
                                                ? userName
